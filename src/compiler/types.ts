namespace ts {
    ...
    export interface TypeChecker {
        ...
        getPathSymbolsAndPathNodesAtLocation(node: Node): [Symbol | undefined, Symbol[], Node[]];
        ...
        startToResolveAlias(symbol: Symbol): [Symbol, Symbol[], Node[]];
    ...
    export interface SymbolLinks {
        ...
        nodeToPreviousNodeMap?: ES6Map<Node, Node>;
        symbolToNodeMap?: ES6Map<Symbol, Node>;
    }
